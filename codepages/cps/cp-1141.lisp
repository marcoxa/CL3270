...
;;; *u2e-codepage-1141*
;;;
;;; IBM CP 1141 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-1141*
  (make-array 256 :element-type 'rune
    ...
    "Implements the EBCDIC->Unicode IBM CP 1141 code page.")


(defparameter *u2e-codepage-1141*
  (make-array 256 :element-type 'octet
    ...
    #| A_ |#     #x41   #xAA   #xB0   #xB1   #x3F   #xB2   #xCC   #x7C   #xBD   #xB4   #x9A   #x8A   #xBA   #xCA   #xAF   #xBC 
    ...
    "Implements the Unicode->EBCDIC IBM CP 1141 code page.")


(defparameter *high-u2e-codepage-1141*
  (make-dict
   :initial-map
   '(
    (#x20AC #x009F) 
    ))
    "Unicode->EBCDIC IBM CP 1141 map for codepoints > #xff.")


(defparameter *codepage-1141*
  (make-codepage
   :id 1141
   :name "Codepage 1141"
   :e2u *e2u-codepage-1141*
   :u2e *u2e-codepage-1141*
   :high-u2e *high-u2e-codepage-1141*
   :esub #x3f
   :ge #x08
