...
;;; *u2e-codepage-1047*
;;;
;;; IBM CP 1047 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-1047*
  (make-array 256 :element-type 'rune
    ...
    #| 5_ |#     #x26   #xE9   #xEA   #xEB   #xE8   #xED   #xEE   #xEF   #xEC   #xDF   #x21   #x24   #x2A   #x29   #x3B   #x5E 
    ...
    #| A_ |#     #xB5   #x7E   #x73   #x74   #x75   #x76   #x77   #x78   #x79   #x7A   #xA1   #xBF   #xD0   #x5B   #xDE   #xAE 
    #| B_ |#     #xAC   #xA3   #xA5   #xB7   #xA9   #xA7   #xB6   #xBC   #xBD   #xBE   #xDD   #xA8   #xAF   #x5D   #xB4   #xD7 
    ...
    "Implements the EBCDIC->Unicode IBM CP 1047 code page.")


(defparameter *u2e-codepage-1047*
  (make-array 256 :element-type 'octet
    ...
    #| 5_ |#     #xD7   #xD8   #xD9   #xE2   #xE3   #xE4   #xE5   #xE6   #xE7   #xE8   #xE9   #xAD   #xE0   #xBD   #x5F   #x6D 
    ...
    #| A_ |#     #x41   #xAA   #x4A   #xB1   #x9F   #xB2   #x6A   #xB5   #xBB   #xB4   #x9A   #x8A   #xB0   #xCA   #xAF   #xBC 
    ...
    #| D_ |#     #xAC   #x69   #xED   #xEE   #xEB   #xEF   #xEC   #xBF   #x80   #xFD   #xFE   #xFB   #xFC   #xBA   #xAE   #x59 
    ...
    "Implements the Unicode->EBCDIC IBM CP 1047 code page.")


(defparameter *high-u2e-codepage-1047*
  (make-dict
   :initial-map
   '(
    
    ))
    "Unicode->EBCDIC IBM CP 1047 map for codepoints > #xff.")


(defparameter *codepage-1047*
  (make-codepage
   :id 1047
   :name "Codepage 1047"
   :e2u *e2u-codepage-1047*
   :u2e *u2e-codepage-1047*
   :high-u2e *high-u2e-codepage-1047*
   :esub #x3f
   :ge #x08
