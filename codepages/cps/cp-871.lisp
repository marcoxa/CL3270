...
;;; *u2e-codepage-871*
;;;
;;; IBM CP 871 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-871*
  (make-array 256 :element-type 'rune
    ...
    #| 9_ |#     #xB0   #x6A   #x6B   #x6C   #x6D   #x6E   #x6F   #x70   #x71   #x72   #xAA   #xBA   #x7D   #xB8   #x5D   #xA4 
    ...
    "Implements the EBCDIC->Unicode IBM CP 871 code page.")


(defparameter *u2e-codepage-871*
  (make-array 256 :element-type 'octet
    ...
    "Implements the Unicode->EBCDIC IBM CP 871 code page.")


(defparameter *high-u2e-codepage-871*
  (make-dict
   :initial-map
   '(
    
    ))
    "Unicode->EBCDIC IBM CP 871 map for codepoints > #xff.")


(defparameter *codepage-871*
  (make-codepage
   :id 871
   :name "Codepage 871"
   :e2u *e2u-codepage-871*
   :u2e *u2e-codepage-871*
   :high-u2e *high-u2e-codepage-871*
   :esub #x3f
   :ge #x08
