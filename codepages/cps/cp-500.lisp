...
;;; *u2e-codepage-500*
;;;
;;; IBM CP 500 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-500*
  (make-array 256 :element-type '(mod #x10000)
    ...
    #| 4_ |#     #x20   #xA0   #xE2   #xE4   #xE0   #xE1   #xE3   #xE5   #xE7   #xF1   #x5B   #x2E   #x3C   #x28   #x2B   #x21 
    #| 5_ |#     #x26   #xE9   #xEA   #xEB   #xE8   #xED   #xEE   #xEF   #xEC   #xDF   #x5D   #x24   #x2A   #x29   #x3B   #x5E 
    ...
    "Implements the EBCDIC->Unicode IBM CP 500 code page.")


(defparameter *u2e-codepage-500*
  (make-array 256 :element-type '(mod #x10000)
    :initial-contents '(
    #|             _0     _1     _2     _3     _4     _5     _6     _7     _8     _9     _A     _B     _C     _D     _E     _F |#
    ...
    #| 7_ |#     #x97   #x98   #x99   #xA2   #xA3   #xA4   #xA5   #xA6   #xA7   #xA8   #xA9   #xC0   #xBB   #xD0   #xA1   #x07 
    ...
    #| A_ |#     #x41   #xAA   #xB0   #xB1   #x9F   #xB2   #x6A   #xB5   #xBD   #xB4   #x9A   #x8A   #xBA   #xCA   #xAF   #xBC 
    ...
    "Implements the Unicode->EBCDIC IBM CP 500 code page.")


(defparameter *high-u2e-codepage-500*
  (make-dict
   :initial-map
   '(
    
    ))
    "Unicode->EBCDIC IBM CP 500 map for codepoints > #xff.")


(defparameter *codepage-500*
  (make-codepage
   :id 500
   :name "Codepage 500"
   :e2u *e2u-codepage-500*
   :u2e *u2e-codepage-500*
   :high-u2e *high-u2e-codepage-500*
   :esub #x3f
   :ge #x08
