...
The library follows very closely the **GO** code with some minimal
**Common Lisp** idioms (e.g., practically no use of the Condition
System).
...
[Lispworks](www.lispworks.com) (a version using the LW native `COMM`
package also worked in the past), but is should be portable to other
**Common Lisp** systems.
