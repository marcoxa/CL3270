...
;;; *u2e-codepage-1148*
;;;
;;; IBM CP 1148 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-1148*
  (make-array 256 :element-type '(mod #x10000)
    ...
    "Implements the EBCDIC->Unicode IBM CP 1148 code page.")


(defparameter *u2e-codepage-1148*
  (make-array 256 :element-type '(mod #x10000)
    :initial-contents '(
    #|             _0     _1     _2     _3     _4     _5     _6     _7     _8     _9     _A     _B     _C     _D     _E     _F |#
    ...
    "Implements the Unicode->EBCDIC IBM CP 1148 code page.")


(defparameter *high-u2e-codepage-1148*
  (make-dict
   :initial-map
   '(
    (#x20AC #x009F) 
    ))
    "Unicode->EBCDIC IBM CP 1148 map for codepoints > #xff.")


(defparameter *codepage-1148*
  (make-codepage
   :id 1148
   :name "Codepage 1148"
   :e2u *e2u-codepage-1148*
   :u2e *u2e-codepage-1148*
   :high-u2e *high-u2e-codepage-1148*
   :esub #x3f
   :ge #x08
