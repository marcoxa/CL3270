...
;;; *u2e-codepage-277*
;;;
;;; IBM CP 277 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-277*
  (make-array 256 :element-type '(mod #x10000)
    ...
    #| 5_ |#     #x26   #xE9   #xEA   #xEB   #xE8   #xED   #xEE   #xEF   #xEC   #xDF   #xA4   #xC5   #x2A   #x29   #x3B   #x5E 
    ...
    "Implements the EBCDIC->Unicode IBM CP 277 code page.")


(defparameter *u2e-codepage-277*
  (make-array 256 :element-type '(mod #x10000)
    :initial-contents '(
    #|             _0     _1     _2     _3     _4     _5     _6     _7     _8     _9     _A     _B     _C     _D     _E     _F |#
    ...
    #| A_ |#     #x41   #xAA   #xB0   #xB1   #x5A   #xB2   #x70   #xB5   #xBD   #xB4   #x9A   #x8A   #xBA   #xCA   #xAF   #xBC 
    ...
    "Implements the Unicode->EBCDIC IBM CP 277 code page.")


(defparameter *high-u2e-codepage-277*
  (make-dict
   :initial-map
   '(
    
    ))
    "Unicode->EBCDIC IBM CP 277 map for codepoints > #xff.")


(defparameter *codepage-277*
  (make-codepage
   :id 277
   :name "Codepage 277"
   :e2u *e2u-codepage-277*
   :u2e *u2e-codepage-277*
   :high-u2e *high-u2e-codepage-277*
   :esub #x3f
   :ge #x08
