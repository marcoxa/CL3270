...
;;; *u2e-codepage-284*
;;;
;;; IBM CP 284 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-284*
  (make-array 256 :element-type 'rune
    ...
    "Implements the EBCDIC->Unicode IBM CP 284 code page.")


(defparameter *u2e-codepage-284*
  (make-array 256 :element-type 'octet
    ...
    #| A_ |#     #x41   #xAA   #xB0   #xB1   #x9F   #xB2   #x49   #xB5   #xA1   #xB4   #x9A   #x8A   #x5F   #xCA   #xAF   #xBC 
    ...
    "Implements the Unicode->EBCDIC IBM CP 284 code page.")


(defparameter *high-u2e-codepage-284*
  (make-dict
   :initial-map
   '(
    
    ))
    "Unicode->EBCDIC IBM CP 284 map for codepoints > #xff.")


(defparameter *codepage-284*
  (make-codepage
   :id 284
   :name "Codepage 284"
   :e2u *e2u-codepage-284*
   :u2e *u2e-codepage-284*
   :high-u2e *high-u2e-codepage-284*
   :esub #x3f
   :ge #x08
