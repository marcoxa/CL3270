...
;;; *u2e-codepage-285*
;;;
;;; IBM CP 285 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-285*
  (make-array 256 :element-type 'rune
    ...
    "Implements the EBCDIC->Unicode IBM CP 285 code page.")


(defparameter *u2e-codepage-285*
  (make-array 256 :element-type 'octet
    ...
    #| A_ |#     #x41   #xAA   #xB0   #x5B   #x9F   #xB2   #x6A   #xB5   #xBD   #xB4   #x9A   #x8A   #x5F   #xCA   #xAF   #xA1 
    ...
    "Implements the Unicode->EBCDIC IBM CP 285 code page.")


(defparameter *high-u2e-codepage-285*
  (make-dict
   :initial-map
   '(
    
    ))
    "Unicode->EBCDIC IBM CP 285 map for codepoints > #xff.")


(defparameter *codepage-285*
  (make-codepage
   :id 285
   :name "Codepage 285"
   :e2u *e2u-codepage-285*
   :u2e *u2e-codepage-285*
   :high-u2e *high-u2e-codepage-285*
   :esub #x3f
   :ge #x08
