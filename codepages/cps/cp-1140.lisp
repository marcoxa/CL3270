...
;;; *u2e-codepage-1140*
;;;
;;; IBM CP 1140 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.



(defparameter *e2u-codepage-1140*
  (make-array 256 :element-type 'rune
    ...
    #| B_ |#     #x5E   #xA3   #xA5   #xB7   #xA9   #xA7   #xB6   #xBC   #xBD   #xBE   #x5B   #x5D   #xAF   #xA8   #xB4   #xD7 
    ...
    "Implements the EBCDIC->Unicode IBM CP 1140 code page.")


(defparameter *u2e-codepage-1140*
  (make-array 256 :element-type 'octet
    ...
    #| A_ |#     #x41   #xAA   #x4A   #xB1   #x3F   #xB2   #x6A   #xB5   #xBD   #xB4   #x9A   #x8A   #x5F   #xCA   #xAF   #xBC 
    ...
    "Implements the Unicode->EBCDIC IBM CP 1140 code page.")


(defparameter *high-u2e-codepage-1140*
  (make-dict
   :initial-map
   '(
    (#x20AC #x009F) 
    ))
    "Unicode->EBCDIC IBM CP 1140 map for codepoints > #xff.")


(defparameter *codepage-1140*
  (make-codepage
   :id 1140
   :name "Codepage 1140"
   :e2u *e2u-codepage-1140*
   :u2e *u2e-codepage-1140*
   :high-u2e *high-u2e-codepage-1140*
   :esub #x3f
   :ge #x08
