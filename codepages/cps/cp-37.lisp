...
;;; *u2e-codepage-37*
;;;
;;; IBM CP 37 <-> Unicode mappings from `https://github.com/unicode-org/icu-data`.
...
(defparameter *e2u-codepage-37*
  (make-array 256 :element-type '(mod #x10000)
    ...
    "Implements the EBCDIC->Unicode IBM CP 37 code page.")
...
(defparameter *u2e-codepage-37*
  (make-array 256 :element-type '(mod #x10000)
    ...
    #| A_ |#     #x41   #xAA   #x4A   #xB1   #x9F   #xB2   #x6A   #xB5   #xBD   #xB4   #x9A   #x8A   #x5F   #xCA   #xAF   #xBC 
    ...
    "Implements the Unicode->EBCDIC IBM CP 37 code page.")


(defparameter *high-u2e-codepage-37*
  (make-dict
   :initial-map
   '(
    
    ))
    "Unicode->EBCDIC IBM CP 37 map for codepoints > #xff.")


(defparameter *codepage-37*
  (make-codepage
   :id 37
   :name "Codepage 37"
   :e2u *e2u-codepage-37*
   :u2e *u2e-codepage-37*
   :high-u2e *high-u2e-codepage-37*
   :esub #x3f
   :ge #x08
